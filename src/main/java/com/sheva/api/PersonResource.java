...
public class PersonResource {
    ...
    public Response findAll() {
        logger.log(FINE, "Find all people request received " + uriInfo.getRequestUri());
    ...
    public Response findById(
        ...
        logger.log(FINE, "Get request received" + uriInfo.getRequestUri());
    ...
    public Response searchByName(
        ...
        logger.log(FINE, String.format("Search request to find person by %s received", uriInfo.getRequestUri().getQuery()));
    ...
    public Response create(
        ...
        logger.log(FINE, "Create new person request received " + uriInfo.getRequestUri());
        final Person personCreated = dao.create(person.getFirstName(), person.getLastName(), person.getDateOfBirth(),
                person.getColor(), person.getFood());
        final URI newPersonUri = uriInfo.getBaseUriBuilder().path(Person.class).path("/" + personCreated.getId()).build();
    ...
    public Response update(
        ...
        logger.log(FINE, String.format("Update request '%s' received.", uriInfo.getRequestUri()));
        person = dao.updateById(id, person);
        logger.log(FINE, "Person updated " + person);
        return Response.ok(person).build();
    }
    ...
    public Response deleteById(
        ...
        logger.log(FINE, String.format("Delete request '%s' received.", uriInfo.getRequestUri()));
        dao.deleteById(id);
